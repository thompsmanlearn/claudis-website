...
const steps = [
  {
    ...
    why: "Ensures directives are current before anything else loads. If the pull fails, Claudis notifies the operator and stops — stale directives are worse than no session.",
  ...
  },
  {
    ...
    what: "First line of DIRECTIVES.md is written to Supabase so external systems (Anvil dashboard, Telegram) can see what Claudis is working on.",
  },
  {
    n: 2,
    ...
    what: "A single file that the operator edits to direct the session. May reference a backlog card (Run: B-NNN) or be a project node with a UUID.",
  },
  {
    n: 3,
  ...
  },
  {
    ...
    why: "The operator can submit questions, comments, or commands to Supabase between sessions. Checked here so their input shapes the session before execution begins.",
  ...
  },
  {
    ...
    what: "Reads acceptance criteria from aadp_project_nodes or BACKLOG.md, checks actual system state. Stops and notifies the operator if stale or review-required.",
  },
  {
    n: 6,
